...
> Collections of awesome WezTerm plugins. [Plugin Guide](https://github.com/wezterm/wezterm/blob/main/docs/config/plugins.md) ⭐ 28,325 | 🐛 1,805 | 🌐 Rust | 📅 2026-08-12. Found something cool? Please [contribute](CONTRIBUTING.md)!
...
* [DrKJeff16/wezterm-types](https://github.com/DrKJeff16/wezterm-types) ⭐ 220 | 🐛 2 | 🌐 Lua | 📅 2026-08-06 - WezTerm type annotations that can be added as a completion source in your editor to provide code assistance when working with WezTerm's Lua API. Includes community plugins support.
...
* [M-Marbouh/agent-quota.wezterm](https://github.com/M-Marbouh/agent-quota.wezterm) ⭐ 4 | 🐛 0 | 🌐 Lua | 📅 2026-07-10 - Shows Claude and Codex quota usage in the status bar with reset countdowns, process-aware states, and shared caching.
...
* [abidibo/wezterm-cmdpicker](https://github.com/abidibo/wezterm-cmdpicker) ⭐ 15 | 🐛 0 | 🌐 Lua | 📅 2026-05-25 - Add a command-palette-style fuzzy picker for keybindings. Press a trigger key to search and execute any keybinding — user-defined, config, or WezTerm defaults.
...
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,710 | 🐛 20 | 🌐 Lua | 📅 2026-08-08 - Provides an addon for seamless pane navigation between Neovim and the WezTerm MUX.
...
* [michaelbrusegard/tabline.wez](https://github.com/michaelbrusegard/tabline.wez) ⭐ 302 | 🐛 3 | 🌐 Lua | 📅 2026-07-23 - A versatile and easy to use retro tab bar with the `lualine.nvim` configuration format.
...
* [yriveiro/wezterm-tabs](https://github.com/yriveiro/wezterm-tabs) ⭐ 30 | 🐛 1 | 🌐 Lua | 📅 2026-03-23 - Configurable tabs for the retro tab bar.
...
* [pro-vi/wezterm-attention](https://github.com/pro-vi/wezterm-attention) ⭐ 16 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-23 - Turns your tab bar into a notification system with colored tab indicators.
