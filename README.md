...
> Collections of awesome WezTerm plugins. [Plugin Guide](https://github.com/wezterm/wezterm/blob/main/docs/config/plugins.md) ⭐ 28,912 | 🐛 1,850 | 🌐 Rust | 📅 2026-09-15. Found something cool? Please [contribute](CONTRIBUTING.md)!
...
* [pro-vi/wezterm-attention](https://github.com/pro-vi/wezterm-attention) ⭐ 20 | 🐛 1 | 🌐 Lua | 📅 2026-09-15 - Turns your tab bar into a notification system with colored tab indicators.
