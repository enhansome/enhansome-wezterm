...
> Collections of awesome WezTerm plugins. [Plugin Guide](https://github.com/wezterm/wezterm/blob/main/docs/config/plugins.md) ⭐ 28,926 | 🐛 1,851 | 🌐 Rust | 📅 2026-09-15. Found something cool? Please [contribute](CONTRIBUTING.md)!
...
* [DrKJeff16/wezterm-types](https://github.com/DrKJeff16/wezterm-types) ⭐ 222 | 🐛 2 | 🌐 Lua | 📅 2026-09-13 - WezTerm type annotations that can be added as a completion source in your editor to provide code assistance when working with WezTerm's Lua API. Includes community plugins support.
...
* [Eric162/wezterm-agent-deck](https://github.com/Eric162/wezterm-agent-deck) ⭐ 73 | 🐛 1 | 🌐 Lua | 📅 2026-03-26 - Monitors AI coding agents, shows status dots in tabs and notifications when agents need attention.
...
* [KawaiiSelbst/nu\_utf8\_hack.wez](https://github.com/KawaiiSelbst/nu_utf8_hack.wez) ⭐ 0 | 🐛 0 | 🌐 Lua | 📅 2026-09-14 - Rough hack for correct handling utf8 symbols with `SHIFT` key with `kitty-keyboard-protocol` for users of nushell.
* [KawaiiSelbst/keys\_bypass.wez](https://github.com/KawaiiSelbst/keys_bypass.wez) ⭐ 0 | 🐛 0 | 🌐 Lua | 📅 2026-09-14 - Bypasses WezTerm shortcuts to send keys to the foreground process (e.g., Zellij or tmux).
...
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,720 | 🐛 2 | 🌐 Lua | 📅 2026-09-12 - Provides an addon for seamless pane navigation between Neovim and the WezTerm MUX.
...
* [adriankarlen/bar.wezterm](https://github.com/adriankarlen/bar.wezterm) ⭐ 242 | 🐛 2 | 🌐 Lua | 📅 2026-09-10 - A configurable tab bar with batteries included.
...
* [pro-vi/wezterm-attention](https://github.com/pro-vi/wezterm-attention) ⭐ 20 | 🐛 1 | 🌐 Lua | 📅 2026-09-17 - Turns your tab bar into a notification system with colored tab indicators.
...
* [usrivastava92/widgets.wez](https://github.com/usrivastava92/widgets.wez) ⭐ 11 | 🐛 0 | 🌐 Lua | 📅 2026-06-29 - Cross-platform status bar widgets for CPU, RAM, battery, network, and disk on macOS, Linux, and Windows.
