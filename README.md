...
> Collections of awesome WezTerm plugins. [Plugin Guide](https://github.com/wezterm/wezterm/blob/main/docs/config/plugins.md) ⭐ 28,515 | 🐛 1,822 | 🌐 Rust | 📅 2026-08-23. Found something cool? Please [contribute](CONTRIBUTING.md)!
...
* [pro-vi/wezterm-attention](https://github.com/pro-vi/wezterm-attention) ⭐ 18 | 🐛 0 | 🌐 Lua | 📅 2026-08-23 - Turns your tab bar into a notification system with colored tab indicators.
