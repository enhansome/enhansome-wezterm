...
> Collections of awesome WezTerm plugins. [Plugin Guide](https://github.com/wezterm/wezterm/blob/main/docs/config/plugins.md) ⭐ 28,855 | 🐛 1,850 | 🌐 Rust | 📅 2026-09-11. Found something cool? Please [contribute](CONTRIBUTING.md)!
...
* [DrKJeff16/wezterm-types](https://github.com/DrKJeff16/wezterm-types) ⭐ 223 | 🐛 2 | 🌐 Lua | 📅 2026-08-28 - WezTerm type annotations that can be added as a completion source in your editor to provide code assistance when working with WezTerm's Lua API. Includes community plugins support.
...
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,719 | 🐛 2 | 🌐 Lua | 📅 2026-09-11 - Provides an addon for seamless pane navigation between Neovim and the WezTerm MUX.
