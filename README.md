...
> Collections of awesome WezTerm plugins. [Plugin Guide](https://github.com/wezterm/wezterm/blob/main/docs/config/plugins.md) ⭐ 28,616 | 🐛 1,830 | 🌐 Rust | 📅 2026-08-28. Found something cool? Please [contribute](CONTRIBUTING.md)!
...
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,716 | 🐛 22 | 🌐 Lua | 📅 2026-08-29 - Provides an addon for seamless pane navigation between Neovim and the WezTerm MUX.
...
* [michaelbrusegard/tabline.wez](https://github.com/michaelbrusegard/tabline.wez) ⭐ 305 | 🐛 2 | 🌐 Lua | 📅 2026-07-23 - A versatile and easy to use retro tab bar with the `lualine.nvim` configuration format.
