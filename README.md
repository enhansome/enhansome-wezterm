...
> Collections of awesome WezTerm plugins. [Plugin Guide](https://github.com/wezterm/wezterm/blob/main/docs/config/plugins.md) ⭐ 29,024 | 🐛 1,880 | 🌐 Rust | 📅 2026-09-21. Found something cool? Please [contribute](CONTRIBUTING.md)!
...
* [mrjones2014/smart-splits.nvim](https://github.com/mrjones2014/smart-splits.nvim) ⭐ 1,726 | 🐛 2 | 🌐 Lua | 📅 2026-09-12 - Provides an addon for seamless pane navigation between Neovim and the WezTerm MUX.
...
* [michaelbrusegard/tabline.wez](https://github.com/michaelbrusegard/tabline.wez) ⭐ 312 | 🐛 3 | 🌐 Lua | 📅 2026-07-23 - A versatile and easy to use retro tab bar with the `lualine.nvim` configuration format.
